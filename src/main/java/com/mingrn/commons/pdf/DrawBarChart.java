...
/**
 * 2D柱状图绘制,可根据需要自定义扩展 <code>BaseCreate</code>
 * 绘制个性化柱状图,如 3D
 *
 * @author MinGRn <br > MinGRn97@gmail.com
 * @date 2019/6/5 16:35
 */
public class DrawBarChart extends BaseCreate {
    ...
    DrawBarChart(int height, int wight) {
        super(height, wight);
    ...
    public JFreeChart drawChart(String title, String xAxisLabel, String yAxisLabel, CategoryDataset categoryDatase, PlotOrientation orientation, boolean legend, boolean toolTip) {
        // 创建柱状图
        JFreeChart chart = ChartFactory.createBarChart(title, xAxisLabel, yAxisLabel, categoryDatase, orientation, legend, toolTip, false);
